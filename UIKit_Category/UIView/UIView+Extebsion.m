...
@implementation UIView (Extebsion)
...
+(void)showAlertMsg:(NSString *)message andShowBgColor:(UIColor *)bgColor andLabelTectColor:(UIColor *)textColor
{
    ...
    showview.backgroundColor = bgColor;
    ...
    //    // 计算文本的大小
    //    CGSize LabelSize = [message boundingRectWithSize:CGSizeMake(690, 9000) // 用于计算文本绘制时占据的矩形块
    ...
    showview.frame = CGRectMake(( YW_ScreenWidth- LabelSize.width - 20)/2, YW_ScreenHeight - 100, LabelSize.width+20, LabelSize.height+10);
